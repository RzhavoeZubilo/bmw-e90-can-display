...
граница, на которой TTP-223 работает неуверенно. Над пятном должно остаться
...
углубление ⌀16 мм на 1.3 мм с плавными краями. Одна деталь делает сразу две
работы: даёт тактильную метку, в которую палец сам попадает и центрируется, и
одновременно **и есть то самое утоньшение** — 2.5 мм крышки минус 1.3 мм
...
сфера, а **усечённый конус с фасками 45°**: ⌀16 по верху, плоское дно ⌀13.4,
переход 1.3 мм. Пальцем разница не ощущается, а печатается без поддержек.
...
| Лунка снаружи | ⌀16, глубина 1.3, фаски 45° |
